...
export const PanelRow = memo(function PanelRow({
  ...
  return (
    <button
      ...
      className={cn(
        'group w-full text-left px-5 py-4 border-b border-gray-100/80 transition-all duration-200',
        // A real focus ring. This used to be `focus:outline-none` with nothing
        // in its place, which made keyboard navigation of the list invisible.
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-gold',
        selected
          ? 'bg-gold/[0.07] border-l-2 border-l-gold pl-[18px]'
          : hovered
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {(item.address || item.city) && (
            <p className="text-[11px] text-gray-500 mt-1 leading-snug truncate">
