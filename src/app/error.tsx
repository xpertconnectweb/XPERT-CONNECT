...
export default function Error({
  ...
  useEffect(() => {
    console.error('Application error', { digest: error.digest, timestamp: new Date().toISOString() })
  }, [error])

  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-navy px-4 text-center">
      <h1 className="font-heading text-7xl font-bold text-gold mb-4">Error</h1>
